...
'</node>',
'</node>',
'<node CREATED="1470782717713" FOLDED="true" ID="ID_98980111" MODIFIED="1470783525131" TEXT="Freeplane Only">',
'<node CREATED="1470782909748" FOLDED="true" ID="ID_647784643" MODIFIED="1470783521212" TEXT="Group 1">',
'<node CREATED="1470782723393" ID="ID_144981814" MODIFIED="1470783006437" TEXT=" Checked">',
'<icon BUILTIN="checked"/>',
'</node>',
'<node CREATED="1470782740632" ID="ID_230429347" MODIFIED="1470783186551" TEXT="Unchecked">',
'<icon BUILTIN="unchecked"/>',
'</node>',
'<node CREATED="1470782745648" ID="ID_283962017" MODIFIED="1470783193266" TEXT="Very Negative">',
'<icon BUILTIN="very_negative"/>',
'</node>',
'<node CREATED="1470782751460" ID="ID_357044565" MODIFIED="1470783195832" TEXT="Negative">',
'<icon BUILTIN="negative"/>',
'</node>',
'<node CREATED="1470782756181" ID="ID_1927982531" MODIFIED="1470783197380" TEXT="Positive">',
'<icon BUILTIN="positive"/>',
'</node>',
'<node CREATED="1470782761489" ID="ID_1266905311" MODIFIED="1470783199340" TEXT="Very Positive">',
'<icon BUILTIN="very_positive"/>',
'</node>',
'<node CREATED="1470782766664" ID="ID_1280504173" MODIFIED="1470783200681" TEXT="0%">',
'<icon BUILTIN="0%"/>',
'</node>',
'<node CREATED="1470782771351" ID="ID_1511742791" MODIFIED="1470783201276" TEXT="25%">',
'<icon BUILTIN="25%"/>',
'</node>',
'<node CREATED="1470782789124" ID="ID_789171747" MODIFIED="1470783201944" TEXT="50%">',
'<icon BUILTIN="50%"/>',
'</node>',
'<node CREATED="1470782797378" ID="ID_128192868" MODIFIED="1470783203338" TEXT="75%">',
'<icon BUILTIN="75%"/>',
'</node>',
'<node CREATED="1470782802902" ID="ID_750490425" MODIFIED="1470783204003" TEXT="100%">',
'<icon BUILTIN="100%"/>',
'</node>',
'<node CREATED="1470782807624" ID="ID_977396693" MODIFIED="1470783204696" TEXT="Revision">',
'<icon BUILTIN="revision"/>',
'</node>',
'<node CREATED="1470782816813" ID="ID_1072450545" MODIFIED="1470783205377" TEXT="Video">',
'<icon BUILTIN="video"/>',
'</node>',
'<node CREATED="1470782822209" ID="ID_1537874305" MODIFIED="1470783206073" TEXT="Audio">',
'<icon BUILTIN="audio"/>',
'</node>',
'</node>',
'<node CREATED="1470782911563" FOLDED="true" ID="ID_857740039" MODIFIED="1470783522524" TEXT="Group 2">',
'<node CREATED="1470782827803" ID="ID_1016790807" MODIFIED="1470783206786" TEXT="Executable">',
'<icon BUILTIN="executable"/>',
'</node>',
'<node CREATED="1470782832460" ID="ID_26688633" MODIFIED="1470783207471" TEXT="Image">',
'<icon BUILTIN="image"/>',
'</node>',
'<node CREATED="1470782837595" ID="ID_1439710736" MODIFIED="1470783208142" TEXT="Internet">',
'<icon BUILTIN="internet"/>',
'</node>',
'<node CREATED="1470782842325" ID="ID_1060693777" MODIFIED="1470783208829" TEXT="Internet warning">',
'<icon BUILTIN="internet_warning"/>',
'</node>',
'<node CREATED="1470782848010" ID="ID_406699905" MODIFIED="1470783209632" TEXT="Mind Map">',
'<icon BUILTIN="mindmap"/>',
'</node>',
'<node CREATED="1470782855688" ID="ID_475247795" MODIFIED="1470783210384" TEXT="Narrative">',
'<icon BUILTIN="narrative"/>',
'</node>',
'<node CREATED="1470782860622" ID="ID_1023015401" MODIFIED="1470783211121" TEXT="Freeplane">',
'<icon BUILTIN="bee"/>',
'</node>',
'<node CREATED="1470782866886" ID="ID_1762232749" MODIFIED="1470783211784" TEXT="Addition">',
'<icon BUILTIN="addition"/>',
'</node>',
'<node CREATED="1470782871992" ID="ID_272870218" MODIFIED="1470783212366" TEXT="Subtraction">',
'<icon BUILTIN="subtraction"/>',
'</node>',
'<node CREATED="1470782876574" ID="ID_10259998" MODIFIED="1470783212900" TEXT="Multiplication">',
'<icon BUILTIN="multiplication"/>',
'</node>',
'<node CREATED="1470782881875" ID="ID_153253704" MODIFIED="1470783213403" TEXT="Division">',
